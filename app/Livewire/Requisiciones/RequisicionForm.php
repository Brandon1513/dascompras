...
class RequisicionForm extends Component
{
    ...
    private function validationMessages(): array
    {
        return [
            ...
            'items..precio_unitario.required' => 'El precio es obligatorio.',
            'items..precio_unitario.numeric'  => 'El precio debe ser un número válido.',
            'items..descripcion.required'     => 'La descripción de la partida es obligatoria.',
            'items.*.descripcion.min'          => 'La descripción debe tener al menos 2 caracteres.',
        ];
    }
