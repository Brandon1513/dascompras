                ...
                <div>
                    <div class="flex items-center gap-2">
                        ...
                        @if($requisicion->urgencia === 'urgente')
                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-xs font-semibold bg-red-100 text-red-700">
                                🔴 Urgente
                            </span>
                        @endif
                    </div>
    ...
    <div class="min-h-screen py-6" style="background: linear-gradient(160deg, #f8f5ff 0%, #f1f5f9 50%, #f8f5ff 100%);">
        <div class="max-w-5xl px-4 mx-auto space-y-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                <div class="flex items-start gap-3 p-3 border border-indigo-100 rounded-xl bg-indigo-50/50">
                    <span class="text-lg shrink-0">📅</span>
                    <div>
                        <p class="text-xs font-semibold text-indigo-800">Plazo de entrega</p>
                        <p class="text-xs text-indigo-600 mt-0.5">El plazo máximo de entrega de bienes o servicios es de <strong>15 días naturales</strong> a partir de la colocación de la orden de compra, salvo casos especiales informados al solicitante.</p>
                    </div>
                </div>
                <div class="flex items-start gap-3 p-3 border rounded-xl border-emerald-100 bg-emerald-50/50">
                    <span class="text-lg shrink-0">💰</span>
                    <div>
                        <p class="text-xs font-semibold text-emerald-800">Programación de pagos</p>
                        <p class="text-xs text-emerald-600 mt-0.5">Para que el pago se considere en la semana en curso, la factura debe recibirse a más tardar el <strong>lunes a las 12:00 pm</strong>.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            @empty
                                <tr><td colspan="9" class="px-4 py-8 text-sm text-center text-gray-400">Sin partidas registradas.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
